...
LARGE_CACTUS = [pygame.image.load(os.path.join("Assets/Object", "LargeCactus1.png")),
                pygame.image.load(os.path.join("Assets/Object", "LargeCactus2.png")),
                pygame.image.load(os.path.join("Assets/Object", "LargeCactus3.png"))]
